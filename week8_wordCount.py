# File: week8_wordCount.py
# Name: Gabriel Valenzuela
# Date: 10/20/2019
# Course: DSC 510 - Introduction to Programming
# Purpose: To read a text file and count the frequency of each word within the document.
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# Desc: Function will print out a list of all words within the document from highest to lowest. At the same time, it
#       will print the number of items within the dictionary
#
# In:   dictionary d - dictionary to be displayed containing all of the words and their frequency within the text
# Out:  none
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
def Pretty_print(d):
    blank = d.pop("")
    print("Length of the dictionary:", d.__len__())
    print("Word            Count")
    print("_______________________")
    sortedList = sorted(d.items(),reverse= True,key=lambda x: x[1])
    for elem in sortedList:
        print('{0:<12} {1:>5}'.format(*elem))
